      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600">Silakan login untuk mengakses tracker Anda</p>
          </div>

          {/* Login Button */}
          <button
            onClick={() => signIn("google", { callbackUrl: "/tracker" })}
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white border-2 border-gray-200 rounded-xl font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transition-all duration-200 group cursor-pointer"
          >
